...
import com.guy.common.utils.ConvertUtils;
...
//	private Object matchValue = null;
	 ...
	 * @param value 待比较的值.
	 */
	public PropertyFilter(final String filterName, final Object... values) {
		...
		for (int i = 0; i < values.length; i++) {
			objects.add(ConvertUtils.convertStringToObject(values[i].toString(), propertyClass));
		}
		this.matchValues=objects.toArray(new Object[]{objects.size()});
	}
...
//		EQ, NEQ, LIKE, LLIKE, RLIKE, LT, GT, LE, GE, IN, NIN,NE;
	}
