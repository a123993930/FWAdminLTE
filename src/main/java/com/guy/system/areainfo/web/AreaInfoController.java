package com.guy.system.areainfo.web;
...
public class AreaInfoController extends BaseController{
     ...
     * 获取区域信息类型json
     */
    @RequestMapping(value="jsonHb",method = RequestMethod.POST)
    @ResponseBody
    public List<AreaInfo> areaInfoListHb(HttpServletRequest request) {
        List<AreaInfo> areaInfoList=areaInfoService.getHb();
        return areaInfoList;
    }
	/**
	 * 获取父节点json
	 */
	@RequestMapping(value="jsonpid",method = RequestMethod.POST)
	@ResponseBody
	public List<AreaInfo> areaInfoPidList(HttpServletRequest request) {
	    List<AreaInfo> areaInfoList=areaInfoService.getInfoByPid(Integer.parseInt(request.getParameter("pid")));
	    return areaInfoList;
	}
